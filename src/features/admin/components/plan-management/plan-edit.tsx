...
export function EditPlanModal({ plan }: { plan: ConvertedPlan }) {
  ...
  const form = useForm<PlanValues>({
    ...
    defaultValues: {
      ...
      roleId: plan.roleId,
      permissionIds: plan.permission?.map((p) => p.permissionId) ?? [],
      planPermissions: plan.planPermission.reduce((acc, curr) => {
