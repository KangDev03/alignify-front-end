  ...
  const forumPosts = [
    {
      ...
      comments: 23,
      content:
        'Chia sẻ một số mẹo nhỏ giúp các bạn influencer chụp ảnh sản phẩm đẹp hơn với ánh sáng tự nhiên...',
      reports: 0,
    },
    {
      id: '2',
      ...
      comments: 15,
      content:
        'Khi mới bắt đầu làm influencer, việc hợp tác với brand có thể khiến bạn cảm thấy lo lắng...',
      reports: 0,
    },
    {
      id: '3',
