  ...
  const brandPlans: SubscriptionPlan[] = [
    {
      ...
      icon: Icons.star,
      color:
        'bg-gray-100 text-gray-800 pointer-events-none hover:bg-transparent hover:text-inherit',
      maxCampaigns: 3,
      maxInfluencers: 5,
      analyticsAccess: false,
      prioritySupport: false,
    ...
    },
    {
      ...
      icon: Icons.crown,
      color:
        'bg-blue-100 text-blue-800 pointer-events-none hover:bg-transparent hover:text-inherit',
      maxCampaigns: 25,
      maxInfluencers: 100,
    ...
    },
    {
      ...
      icon: Icons.zap,
      color:
        'bg-purple-100 text-purple-800 pointer-events-none hover:bg-transparent hover:text-inherit',
      maxCampaigns: -1,
      maxInfluencers: -1,
      analyticsAccess: true,
      prioritySupport: true,
  ...
  const influencerPlans: SubscriptionPlan[] = [
    {
      ...
      icon: Icons.camera,
      color:
        'bg-green-100 text-green-800 pointer-events-none hover:bg-transparent hover:text-inherit',
      maxApplications: 5,
      portfolioItems: 10,
      analyticsAccess: false,
      prioritySupport: false,
    },
    {
      ...
      icon: Icons.star,
      color:
        'bg-orange-100 text-orange-800 pointer-events-none hover:bg-transparent hover:text-inherit',
      maxApplications: -1,
      portfolioItems: -1,
      analyticsAccess: true,
      prioritySupport: true,
    },
    {
      ...
      features: [
        'Quản lý nhiều tài khoản influencer trong cùng một dashboard',
        'Quản lý khách hàng và chiến dịch theo nhóm',
        'Có nhân viên hỗ trợ riêng',
        'Tùy chỉnh tích hợp và hỗ trợ nâng cao',
        'Truy cập dashboard dành riêng cho agency',
      ],
      subscribers: 150,
      isActive: true,
      createdAt: '2024-01-01',
      ...
      color:
        'bg-indigo-100 text-indigo-800 pointer-events-none hover:bg-transparent hover:text-inherit',
      maxApplications: -1,
      portfolioItems: -1,
      analyticsAccess: true,
      prioritySupport: true,
