import { BadgeCheckIcon, Calendar, Dot,Eye  } from 'lucide-react';
...
export default function ViewAccepted({ campaign }: { campaign: Campaign }) {
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[637px] h-fit gap-4">
        ...
        <DialogFooter>
          <DialogClose asChild>
            <Button  className='bg-primary'>Chiến dịch của tôi</Button>
          </DialogClose>
        </DialogFooter>
      </DialogContent>
    </Dialog>
