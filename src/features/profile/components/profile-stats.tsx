...
export function ProfileStats({
  ...
  const socialPlatforms = [
    { name: "Instagram", icon: Icons.instagram, color: "text-pink-500", followers: influencer.followers.instagram },
    { name: "YouTube", icon: Icons.youtube, color: "text-red-500", followers: influencer.followers.youtube },
    { name: "Facebook", icon: Icons.facebook, color: "text-blue-500", followers: influencer.followers.facebook },
  ]
