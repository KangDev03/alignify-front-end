  ...
  const influencerPlans: Plan[] = [
    {
      ...
      features: [
        ...
        { name: "Portfolio 10 hình ảnh", included: true, limit: "10 ảnh" },
        { name: "Thống kê cơ bản", included: true },
        { name: "Chat với brands", included: true },
        { name: "Hỗ trợ email", included: true },
        { name: "Media kit tự động", included: false },
        { name: "Priority trong search", included: false },
        { name: "Analytics chi tiết", included: false },
        { name: "Quản lý nhiều hồ sơ", included: false },
      ],
    ...
    },
    {
      ...
      features: [
        ...
        { name: "Media kit tự động", included: true },
        { name: "Priority trong search", included: true },
        { name: "Analytics chi tiết", included: true },
        { name: "Hỗ trợ ưu tiên", included: true },
        { name: "Tích hợp social media", included: true },
    ...
    },
    {
      ...
      period: isAnnual ? "/năm" : "/tháng",
      description: "Cho agency quản lý nhiều influencer",
      badge: "Cao cấp",
      badgeColor: "bg-purple-500",
      features: [
        { name: "Quản lý nhiều hồ sơ influencer", included: true, limit: "Không giới hạn" },
        { name: "Agency dashboard", included: true },
  ...
  const brandPlans: Plan[] = [
    {
      ...
      features: [
        ...
        { name: "Automated matching", included: false },
        { name: "Advanced analytics", included: false },
        { name: "Multi-brand management", included: false },
      ],
      buttonText: "Gói hiện tại",
      buttonVariant: "secondary",
    },
    {
      ...
      features: [
        ...
        { name: "Automated matching", included: true },
    ...
    },
    {
      ...
      features: [
        ...
        { name: "Không giới hạn team members", included: true, limit: "Không giới hạn" },
        { name: "API access", included: true },
    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
        ...
        <Card className="text-center p-6">
          ...
          <p className="text-sm text-muted-foreground">Dữ liệu được bảo vệ với tiêu chu���n enterprise</p>
        </Card>
        <Card className="text-center p-6">
